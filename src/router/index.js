...
const routes = [
  ...
  { path: '/profile/:uid', component : Profile, icon: 'far fa-user-circle fa-fw text-2xl', meta: { isMenu: false, layout: 'DefaultLayout', requireAuth: true}},
  ...
  { path: '/tweet/:id', name: 'tweet', component : TweetDetail, meta: { isMenu: false, layout: 'DefaultLayout', requireAuth: true}},
