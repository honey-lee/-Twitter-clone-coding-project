    ...
    <div class="flex-1 flex flex-col border-r border-color">
      ...
      <div class="px-3 py-1 flex border-b border-color">
        ...
        <div>
          ...
          <div class="text-sm text-gray">{{ currentUser.num_tweets }} 트윗</div>
        </div>
      </div>
      <!-- background image -->
      ...
      <!-- profile edit button -->
      <div class="text-right mt-2 mr-2 mb-4 relative">
      ...
      <div class="mx-3 mt-2">
        ...
        <div>
          <span class="font-bold mr-1">{{ currentUser.followings.length }}4</span>
      ...
      <div class="flex justify-between border-b border-color mt-3">
        ...
        <div @click="currentTab = 'retweets'" :class="`${currentTab == 'retweets' ? 'border-b border-primary text-primary' : 'text-gray'} py-3 text-gray w-1/3 font-bold text-center hover:bg-blue-50 cursor-pointer hover:text-primary`">리트윗</div>
      ...
      <div class="overflow-y-auto">
        <Tweet v-for="tweet in currentTab == 'tweet' ? tweets : currentTab == 'retweets' ? retweets : likeTweets" :key="tweet.id" :currentUser="currentUser" :tweet="tweet"/>
      </div>
    </div>
    <!-- trend section -->
    <Trends />
